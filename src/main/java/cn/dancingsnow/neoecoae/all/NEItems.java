...
public class NEItems {
        ...
        public static final ItemEntry<NESmithingTemplateItem> ALUMINUM_ALLOY_UPGRADE_SMITHING_TEMPLATE = REGISTRATE
                        .item("aluminum_alloy_upgrade_smithing_template", p -> new NESmithingTemplateItem(
                                        ...
                                        REGISTRATE.addLang("item", NeoECOAE
                                                        .id("smithing_template.aluminum_alloy_upgrade.applies_to"),
                                                        "Aluminum Equipment").withStyle(ChatFormatting.BLUE),
                                        REGISTRATE.addLang("item", NeoECOAE
                                                        .id("smithing_template.aluminum_alloy_upgrade.ingredients"),
                                                        "Aluminum Alloy Ingot").withStyle(ChatFormatting.BLUE),
                                        REGISTRATE.addLang("upgrade", NeoECOAE.id("aluminum_alloy_upgrade"),
